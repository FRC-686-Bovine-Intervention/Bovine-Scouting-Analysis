...
try {
  ...
  assert(result.verification.availableIdentifiers.includes("tba.endGameHarmonyPoints"), `Expected camelCased raw tba.endGameHarmonyPoints for 2024. Got ${JSON.stringify(result.verification.availableIdentifiers)}`);
