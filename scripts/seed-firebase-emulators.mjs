...
await writeDocument("events/2026cached", { key: "2026cached", season: 2026, name: "Cached Emulator Event", seasonLabel: "2026 Cached", workspace: { source: "emulator-seed" }, cachedAt: timestamp });
await writeSourceArtifact("2026cached", "tba-event", { key: "2026cached", year: 2026, name: "Cached Emulator Event", short_name: "Cached Emulator Event" });
await writeSourceArtifact("2026cached", "tba-teams", [{ key: "frc9999", team_number: 9999, nickname: "Local Team" }]);
await writeSourceArtifact("2026cached", "tba-matches", []);
await writeSourceArtifact("2026cached", "tba-rankings", {});
await writeSourceArtifact("2026cached", "tba-oprs", {});
await writeSourceArtifact("2026cached", "statbotics-event", { event: "2026cached", year: 2026, name: "Cached Emulator Event" });
await writeSourceArtifact("2026cached", "statbotics-team-events", []);
