...
$sim = Start-Process node -ArgumentList @('eventSimulator/server.mjs', $SimulatorPort) -WorkingDirectory $root -PassThru -WindowStyle Hidden -Environment @{ EVENT_SIMULATOR_STATE = $statePath }
